                        ...
                        html.Div([
                                 html.Div([
                                  ...
                                  dcc.Dropdown(id='dropdown1',
                                                    ...
                                                    value='All Sub-Category',clearable=True,style={'width': '200px','font-size':'15px','padding-left': '20px',"background-color":"rgba(235, 254, 255, 0.8)"})],style={'width': '20%','display': 'inline-block','textAlign':'center'})],style={'textAlign':'center'}),
                                  html.Br(),
...
def update_graphvalue2(value):
    ...
    if value == "All Sub-Category" or value is None:
        fig = make_subplots(rows=2, cols=1)
    ...
    if value!="All Sub-Category" and value is not None:
        # print(f"----subcst{value}")
